...
NDiplomacy = {
	...
	VOLUNTEERS_DIVISIONS_REQUIRED = 13,				-- This many divisons are required for the country to be able to send volunteers.
	...
	TENSION_TIME_SCALE_START_DATE = "2040.1.1.12",	-- Starting at this date, the tension values will be scaled down (will be equal to 1 before that)
...
NCountry = {
	...
	MAJOR_IC_RATIO = 1.5,                             -- difference in total factories needed to be considered major with respect to other nation
	MAJOR_MIN_FACTORIES = 150,						-- need at least these many factories to become a major
	...
	MIN_FOCUSES_FOR_CONTINUOUS = 5,				-- Focuses needed to unlock continuous focuses
...
NAI = {
	...
	FOCUS_TREE_CONTINUE_FACTOR = 2,			-- Factor for score of how likely the AI is to keep going down a focus tree rather than starting a new path.
	...
	CALL_ALLY_BASE_DESIRE = -1000,					-- exactly what it says
	CALL_ALLY_DEMOCRATIC_DESIRE = -1000,			-- Desire to call ally added for democratic AI
	CALL_ALLY_NEUTRAL_DESIRE = -1000,				-- Desire to call ally added for neutral AI
	CALL_ALLY_FASCIST_DESIRE = -1000,				-- Desire to call ally added for fascist AI
	CALL_ALLY_COMMUNIST_DESIRE = -1000,			-- Desire to call ally added for communist AI
	CALL_ALLY_PUPPET_INVITE_OVERLORD = -1000,    -- Desire for a puppet to call its overlord into the war
	CALL_ALLY_OVERLORD_INVITE_PUPPET = -1000,      -- Desire for an overlord to call its puppet into the war
	...
	JOIN_ALLY_BASE_DESIRE = -1000,					-- exactly what it says
	JOIN_ALLY_DEMOCRATIC_DESIRE = -1000,			-- Desire to join ally added for democratic AI
	JOIN_ALLY_NEUTRAL_DESIRE = -1000,				-- Desire to join ally added for neutral AI
	JOIN_ALLY_FASCIST_DESIRE = -1000,				-- Desire to join ally added for fascist AI
	JOIN_ALLY_COMMUNIST_DESIRE = -1000,			-- Desire to join ally added for communist AI
	JOIN_FACTION_BOTH_LOSING = -1000,			-- Desire to be in a faction when both we and htey are in losing wars
